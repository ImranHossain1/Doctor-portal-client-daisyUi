...
const AddDoctor = () => {
    ...
    const {data : services, isLoading} = useQuery('services',()=> fetch('https://mighty-savannah-08199.herokuapp.com/service').then(res=>res.json()))
    ...
    const onSubmit =async data => {
        ...
        .then(result=>{
            if(result.success){
                ...
                fetch('https://mighty-savannah-08199.herokuapp.com/doctor',{
                    method: 'POST',
                    headers: {
